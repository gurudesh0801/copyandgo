      ...
      <div className="w-full max-w-6xl">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          ...
          <button
            ...
            className="group relative p-3 rounded-xl bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 hover:from-gray-200 hover:to-gray-300 dark:hover:from-gray-700 dark:hover:to-gray-600 transition-all duration-300 shadow-lg hover:shadow-xl active:scale-95"
          ...
          >
            ...
            <div className="absolute inset-0 rounded-xl border-2 border-transparent group-hover:border-blue-500/20 transition-colors"></div>
          </button>
        </header>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={undo}
                    disabled={step <= 0}
                    className={`px-4 py-3 text-white rounded-lg font-medium transition-all duration-300 ${
                      step <= 0
                        ? "opacity-50 cursor-not-allowed bg-gray-100 dark:bg-gray-800"
                        : "hover:bg-gray-100 dark:hover:bg-gray-700 border-2 border-gray-200 dark:border-gray-700"
                    }`}
                  >
                    ↩ Undo
                  </button>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2 border-2 text-white border-gray-300 dark:border-gray-600 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:bg-gray-900/50 transition-colors"
